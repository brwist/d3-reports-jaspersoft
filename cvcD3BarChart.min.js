...
define('d3Bar', ['d3v4'], function (d3) {
	...
	return function (instanceData) {
		...
		var svg = d3.select("#" + instanceData.id).insert("svg")
			.attr("id", instanceData.id + "_barchart")
		...
		// the values to be represented on the y Axis
		var valuesSeries = instanceData.series[0];
		// the categories to be represented on the x Axis
		var categoriesSeries = instanceData.series[1];

		// array of objects for the chart
		var data = new Array();

		// Prepare the data array
		for (let index = 0; index < valuesSeries.length; index++) {
			const value = valuesSeries[index];
			const category = categoriesSeries[index];
			data[index] = {"category": category.value, "value": value.value}; 
		}
